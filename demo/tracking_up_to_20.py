...
def parse_args():
    ...
    parser.add_argument('--output-dir', default='video_outputs')
...
def main():
    ...
    #frame_paths = frame_paths[:20]  # ✅ Only first 10 frames
    ...
    for frame_path, idx in tqdm(frame_paths, desc="Processing frames"):
        ...
        with open(os.path.join(json_dir, f"frame_{idx:05d}.json"), "w") as f:
